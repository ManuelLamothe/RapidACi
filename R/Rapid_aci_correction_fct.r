...
#'   for the leaf area provided (as is if leafArea_mm2 = NA). Then those values will be
#'   adjusted according to matching empty chamber measurements and finally prepared for
#'   further modelling analysis in a Rlist object.
#'
